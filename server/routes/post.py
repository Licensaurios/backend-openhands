...
from server.controllers.community import get_popular_tags
post_router = Blueprint('post', __name__, url_prefix='/api/post')

# --- LECTURA Y FEEDS ---
post_router.route('/<uuid:post_id>', methods=['GET'])(get_single_post)
...
# --- TEMAS Y TAGS (TOPICS) ---
post_router.route('/topics/all', methods=['GET'])(get_all_topics)
post_router.route('/topics/trending', methods=['GET'])(get_trending_topics)
post_router.route('/tags/trending', methods=['GET'])(get_popular_tags)